...
public class BixolonPrinter implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener {
            ...
            for (int i = 0; i < retry; i++) {
                try {
                    ...
                    try {
                        ...
                        e1.printStackTrace();
                        Log.d(TAG, "JposException1:" + e1.getMessage());
                    }
                }
            }
        }
    ...
    public boolean printerClose() {
        ...
        try {
            ...
            Log.d(TAG, "JposException : " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public boolean printText(String data, int alignment, int attribute, int textSize) {
        ...
        try {
            ...
            Log.d(TAG, "P-strOption : " + strOption);
            Log.d(TAG, "P-data : " + data);
            ...
            e.printStackTrace();
            Log.d("P-JposException", "JposException : " + e.getMessage());
